...
class saveDriverBloc {
  ...
  final saveDriver = PublishSubject<ResponseModel>();
  ...
  SaveDriver() async {
    ResponseModel _saveDriver = await repository.save_driver(name_first, name_second, lastName_first , lastName_second , document_type, document_number,
