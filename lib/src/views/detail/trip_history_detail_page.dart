...
class DetailTripHistory extends StatelessWidget {
  const DetailTripHistory({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final tripHistoryProvider = context.watch<ListTripHistoryDriverBloc>();
    final detailTrip = tripHistoryProvider.selectTripHistory;

    String name = detailTrip.driver.firstName +" "+  detailTrip.driver.secondName+" "+ detailTrip.driver.firstLastName +" "+detailTrip.driver.secondLastName;
    String account = detailTrip.driver.accountType.name +" - "+detailTrip.driver.accountNumber ;
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            TextRow('trip_history_card_detail_data_driver_name'.tr(),name) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_driver_document'.tr(), detailTrip.driver.documentNumber) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_driver_phone'.tr(), detailTrip.driver.phone) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_driver_address'.tr(), detailTrip.driver.address) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_driver_bank'.tr(), detailTrip.driver.bank.bankName) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_driver_account'.tr(), account)
                          ]
                        )
                      )
                    ),
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            TextRow('trip_history_card_detail_data_Vehicle_name'.tr(),detailTrip.driver.vehicleType.name) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_plate_name'.tr(), detailTrip.driver.plateNumber) ,
                            SizedBox(height: 10.h),
                            TextRow('trip_history_card_detail_data_year_name'.tr(), detailTrip.driver.vehicleYear) ,
                          ]
                        )
                      )
                    ),
                    ...
                    Card(
                        ...
                        child: Container(
                            ...
                            child: Column(
                                children: [
                                  TextRow('trip_history_card_detail_data_earning_money'.tr(),detailTrip.totalMoneyEarned) ,
                                  SizedBox(height: 10.h),
                                  TextRow('trip_history_card_detail_data_earning_tokens'.tr(),detailTrip.totalTokensEarned) ,
                                ]
                            )
                        )
                    ),
