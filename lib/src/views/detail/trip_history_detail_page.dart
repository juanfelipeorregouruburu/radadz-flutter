...
class DataDetailTripHistory extends StatelessWidget {
  ...
  String getSecondsHour(startTime , endTime) {
    ...
    String hoursStr = (hour % 60).toString().padLeft(2, '0');
  ...
  Widget build(BuildContext context) {
    ...
    var data_account = detailTrip.driver.accountType == null ? '' : "${formatString(detailTrip.driver.accountType.name)}" +" - "+detailTrip.driver.accountNumber;
    ...
    return Column(
      ...
      children: [
        Center(
          child: Text('payment_card_title_payment_detail'.tr(), style: StyleGeneral.styleTextTitle, textAlign: TextAlign.left)
        ),
        ...
        Align(
          ...
          child: Text('trip_history_card_detail_data_driver'.tr(), style: StyleGeneral.styleTextTextCardPaymentSubtitleCard, textAlign: TextAlign.left)
        ),
        ...
        Align(
          alignment: Alignment.topLeft,
          child: Text('trip_history_card_detail_data_Vehicle'.tr(), style: StyleGeneral.styleTextTextCardPaymentSubtitleCard, textAlign: TextAlign.left)
        ),
        ...
        Card(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                TextRowCardWidget(text_row_title: 'trip_history_card_detail_data_Vehicle_name'.tr(), text_row_data: "${formatString(detailTrip.driver.vehicleType.name)}"),
                SizedBox(height: 10.h),
        ...
        Align(
          alignment: Alignment.topLeft,
          child: Text('trip_history_card_detail_data_earning'.tr(), style: StyleGeneral.styleTextTextCardPaymentSubtitleCard, textAlign: TextAlign.left,)
        ),
        ...
        Align(
          alignment: Alignment.topLeft,
          child: Text('trip_history_card_detail_data_trip'.tr(), style: StyleGeneral.styleTextTextCardPaymentSubtitleCard, textAlign: TextAlign.left)
        ),
